...
object ArtifactStore {
    def toStringBody(var_key: Object, var_description: Object, var_metadata: Object, var_disabled: Object, var_packageType: Object, var_name: Object, var_type: Object, var_disable_timeout: Object, var_path_style: Object, var_path_mask_patterns: Object, var_authoritative_index: Object, var_create_time: Object) =
        s"""
        | {
        | "key":$var_key,"description":$var_description,"metadata":$var_metadata,"disabled":$var_disabled,"packageType":$var_packageType,"name":$var_name,"type":$var_type,"disable_timeout":$var_disable_timeout,"path_style":$var_path_style,"path_mask_patterns":$var_path_mask_patterns,"authoritative_index":$var_authoritative_index,"create_time":$var_create_time
        | }
        """.stripMargin
}
