...
class MavenContentAccessAndStorageApiSimulation extends Simulation {
    ...
    val doGet_2PerSecond = config.getDouble("performance.operationsPerSecond.doGet_2") * rateMultiplier * instanceMultiplier
    ...
    val doDeleteQUERYFeeder1 = csv(userDataDirectory + File.separator + "doDelete-queryParams.csv").random
    val doDeletePATHFeeder1 = csv(userDataDirectory + File.separator + "doDelete-pathParams.csv").random
    val doDeleteQUERYFeeder = csv(userDataDirectory + File.separator + "doDelete_0-queryParams.csv").random
    ...
    val doGetPATHFeeder3 = csv(userDataDirectory + File.separator + "doGet_0-pathParams.csv").random
    val doGetPATHFeeder2 = csv(userDataDirectory + File.separator + "doGet_1-pathParams.csv").random
    val doGetPATHFeeder = csv(userDataDirectory + File.separator + "doGet_2-pathParams.csv").random
    ...
    val scndoCreate = scenario("doCreateSimulation")
        ...
        .exec(http("doCreate")
        .httpRequest("PUT","/api/content/generic-http/${type}/${name}/${path}")
)
    ...
    val scndoCreate_0 = scenario("doCreate_0Simulation")
        ...
        .httpRequest("PUT","/api/content/maven/${type}/${name}/${path}")
)
    ...
    val scndoDelete = scenario("doDeleteSimulation")
        ...
        .exec(http("doDelete")
        .httpRequest("DELETE","/api/content/generic-http/${type}/${name}/${path}")
    ...
    val scndoDelete_0 = scenario("doDelete_0Simulation")
        ...
        .httpRequest("DELETE","/api/content/maven/${type}/${name}/${path}")
        .queryParam("cache-only","${cache-only}")
)
    ...
    val scndoGet = scenario("doGetSimulation")
        ...
        .exec(http("doGet")
        .httpRequest("GET","/api/content/generic-http/${type}/${name}")
)
    ...
    val scndoGet_0 = scenario("doGet_0Simulation")
        .feed(doGetPATHFeeder)
        .exec(http("doGet_0")
        .httpRequest("GET","/api/content/generic-http/${type}/${name}/${path}")
)
    ...
    val scndoGet_1 = scenario("doGet_1Simulation")
        .feed(doGetPATHFeeder)
        .exec(http("doGet_1")
        .httpRequest("GET","/api/content/maven/${type}/${name}")
)
    ...
    val scndoGet_2 = scenario("doGet_2Simulation")
        .feed(doGetPATHFeeder)
        .exec(http("doGet_2")
        .httpRequest("GET","/api/content/maven/${type}/${name}/${path}")
)

    // Run scndoGet_2 with warm up and reach a constant rate for entire duration
    scenarioBuilders += scndoGet_2.inject(
        rampUsersPerSec(1) to(doGet_2PerSecond) during(rampUpSeconds),
        constantUsersPerSec(doGet_2PerSecond) during(durationSeconds),
        rampUsersPerSec(doGet_2PerSecond) to(1) during(rampDownSeconds)
    )
    ...
    val scndoHead = scenario("doHeadSimulation")
        ...
        .exec(http("doHead")
        .httpRequest("HEAD","/api/content/generic-http/${type}/${name}/${path}")
        .queryParam("cache-only","${cache-only}")
)
    ...
    val scndoHead_0 = scenario("doHead_0Simulation")
        ...
        .feed(doHeadPATHFeeder)
        .exec(http("doHead_0")
        .httpRequest("HEAD","/api/content/maven/${type}/${name}/${path}")
        .queryParam("cache-only","${cache-only}")
)
