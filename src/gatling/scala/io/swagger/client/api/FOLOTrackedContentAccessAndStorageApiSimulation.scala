...
class FOLOTrackedContentAccessAndStorageApiSimulation extends Simulation {
    ...
    val scndoCreate = scenario("doCreateSimulation")
        ...
        .exec(http("doCreate")
        .httpRequest("PUT","/api/folo/track/${id}/${type}/${name}/${path}")
)
    ...
    val scndoGet = scenario("doGetSimulation")
        ...
        .exec(http("doGet")
        .httpRequest("GET","/api/folo/track/${id}/${type}/${name}/${path}")
)
    ...
    val scndoHead = scenario("doHeadSimulation")
        ...
        .exec(http("doHead")
        .httpRequest("HEAD","/api/folo/track/${id}/${type}/${name}/${path}")
